...
/**
 * Header and toolbar actions for landing page
 * @param {Object} props
 * @param {() => void} props.onOpenRandom
 * @param {() => void} props.onNavigateCollections
 * @param {() => void} props.onNavigateSettings
 * @returns {JSX.Element}
 */
export default function LandingHeader({ onOpenRandom, onNavigateCollections, onNavigateSettings }) {
  return (
