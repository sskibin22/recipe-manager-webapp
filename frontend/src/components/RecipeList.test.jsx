...
describe("RecipeList", () => {
  it("should display loading state", () => {
    renderWithProviders(
      <RecipeList recipes={[]} isLoading={true} error={null} />,
    );
  ...
  it("should display empty state when no recipes", () => {
    renderWithProviders(
      <RecipeList recipes={[]} isLoading={false} error={null} />,
    );

    expect(screen.getByText(/No recipes found/i)).toBeInTheDocument();
    expect(
      screen.getByText(/Add your first recipe to get started!/i),
    ).toBeInTheDocument();
  });

  it("should render recipe cards when recipes are provided", () => {
    renderWithProviders(
      <RecipeList recipes={mockRecipes} isLoading={false} error={null} />,
    );
  ...
  it("should handle null recipes gracefully", () => {
    renderWithProviders(
      <RecipeList recipes={null} isLoading={false} error={null} />,
    );
  ...
  it("should handle undefined recipes gracefully", () => {
    renderWithProviders(
      <RecipeList recipes={undefined} isLoading={false} error={null} />,
    );
